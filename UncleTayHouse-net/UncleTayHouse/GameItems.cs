...
namespace UncleTayHouse
{
    public class GameItems
    {
        ...
        [
            ...
            new() { id = 9,  location =  9,  objId = 42,  name = "NOTE",         desc = "The writing is reversed. Try to read it somewhere else..." },
        ...
        [
            ...
            new() { id = 13, rname = "MASTER BEDROOM", rdesc = "This large corner bedroom has solid walnut furniture and a large mirror in the wall" },

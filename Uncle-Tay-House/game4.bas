...
# --- DIM --- RNAME$(31), REXIT(31,6), RDESC$(31)
FOR I = 1 TO 31
READ D2$
RNAME$(I) = D2$
FOR J = 1 TO 6
...
9500
 SCORE = 50
 FOR I = 16 TO 20: IF ILOC(I) = 0 THEN SCORE = SCORE + 10
 NEXT
 FOR I = 3 TO 30: FOR J = 1 TO 6: IF REXIT(I,J) = -1 THEN SCORE = SCORE -5
 NEXT J, I
 FOR I = 1 TO 15: IF ILOC(I) = -1 THEN SCORE = SCORE - 5
 NEXT
...
REM # DECODE AND PRINT TEXT
10000 
 D2$ = "" 
 IF D$ = "" THEN GOTO 10070
10005
 CS = 0
...
10060
 ...
 GOTO endgame_19999
10070 
    IF SP THEN PRINT "."; REM # loading
10071 :debug
    PRINT D$ : PRINT D2$ : PRINT "---"
10099
    RETURN
...
19000
 D$ = "YOU HAVE DIED": GOSUB 11000: GOTO endgame_19999

19900
 GOSUB 9500: IF SCORE = 100 THEN D$ = "YOU HAVE WON THE GAME!": GOSUB 11000

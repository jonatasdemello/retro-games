...
1050 LOC=20: ILOC(7)=0: ILOC(9)=0: ILOC(15)=0
...
6559 IF LCL = 29 AND ARG = 12 THEN D$ = "YOU CAN'T DO THAT": PRINT D$: GOTO 5000
...
7119 REM *** 27-OPEN ***
7120 ARG = INPTK(2) - ITEMOFF: IF COMM <> 27 AND (ARG < 1 OR ARG > LASTITEM) THEN D$ = "HUH? 5": PRINT D$: GOTO 5000

7129 REM *** 23-UNLOCK 29-OIL 28-OILCAN *** AND ILOC(ARG) <> LCL AND ILOC(ARG) <> 0
7130 IF COMM <> 23 AND COMM <> 29 AND ILOC(15) <> 0 THEN D$= "IT'S NOT HERE 3": PRINT D$: GOTO 5000
...
7500 IF LCL <> 12 THEN D$ = "YOU CAN'T DO THAT": PRINT D$: GOTO 5000
...
7700 IF LCL <> 20 THEN D$ = "YOU CAN'T DO THAT": PRINT D$: GOTO 5000
...
7800 IF LCL <> 30 OR (INPTK(2) - ITEMOFF <> 3) THEN D$ = "YOU CAN'T DO THAT": GOTO 5000
...
19000 D$ = "YOU HAVE DIED": PRINT D$: GOTO 20000
...
20005 FOR I=1 TO LASTITEM: PRINT " ILOC(";I;")=";ILOC(I): NEXT I
20099 RETURN

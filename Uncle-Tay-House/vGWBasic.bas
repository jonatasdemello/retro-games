...
705 REM PR#3 : TEXT : HOME 
706 PRINT "LOADING..."; : SP = 1
...
1060 SP = 0 : REM HOME
2000 GOSUB 15000
2500 IF LCL = 30 THEN D$= "5... FSI XUWNSL GFHP1": GOSUB 11000: LCL = 12
...
2569 NEXT
2570 IF LCL = 17 AND REXIT(17,1) > 0 THEN D$="3BRXU XQFOH'V GREHUPDQ LV VQRULQJ SHDFHIXOOB3": GOSUB 11000
2580 IF LCL = 3 AND ILOC(6) = -12 THEN D$="9J KDWPNN LXAM MJWPUNB OAXV CQN AJRURWP JKXEN5": GOSUB 11000
2582 IF LCL = 12 AND ILOC(6) = -12 THEN D$="8I JCVOMM KWZL LIVOTMA NZWU BPM ZIQTQVO0": GOSUB 11000
2600 FOR I = 1 TO LASTITEM: IF ILOC(I) = LCL THEN PRINT "THERE IS A "; VOCAB$(I + ITEMOFF); " HERE"
2619 NEXT
2620 IF LCL = 2 AND ILOC(3) = -1 THEN D$= "6YUSKZNOTM OY HGXKRE BOYOHRK ATJKX ZNK LXOJMK5": GOSUB 11000
2650 IF LCL = 3 AND ILOC(5) = 30 THEN D$= "5YMJWJ NX F UNHYZWJ MNLM ZU TS YMJ BFQQ6": GOSUB 11000
4999 IF LCL = 30 THEN TURN1 = 1
5000 IF TURN1 <> 1 AND LCL = 30 THEN D$= "1...BOE TQSJOH CBDL1": GOSUB 11000: LCL = 12: GOTO 2500
...
6300 IF LCL <> 12 THEN D$= "4ALS EVI CSY, HEZMH PII VSXL?8": GOSUB 11000: GOTO 5000
6320 IF ILOC(6) <> -12 THEN D$ = "4CSY JSVKSX CSYV TEVEGLYXI2": GOSUB 11000: GOTO 5000
6330 D$= "9HXD KDWPNN XOO CQN KJULXWH...5": GOSUB 11000: LCL = 30: GOTO 2510
...
6510 IF ILOC(ARG) = 30 AND LCL = 3 AND ARG = 5 THEN D$= "2KV'U VQQ JKIJ0": GOSUB 11000: GOTO 5000
6520 IF ILOC(ARG) <> LCL THEN D$ = "5NY'X STY MJWJ3": GOSUB 11000: GOTO 5000
...
6559 IF LCL = 29 AND ARG = 12 THEN D$ = "5DTZ HFS'Y IT YMFY9": GOSUB 11000: GOTO 5000
6530 IC = IC + 1: IF LCL = 30 AND ARG = 5 THEN D$ = "7AHRPUN AOL WPJABYL YLCLHSZ H MBZLIVE6": GOSUB 11000: ILOC(ARG) = 0: ILOC(IMMOFF+7) = 30: GOTO 2500
...
6630 IC = IC - 1: IF LCL = 17 AND ARG = 10 AND REXIT(17,1) <= 0 THEN D$= "7AOL KVN SVVRZ KPZNBZALK.  THFIL FVB ZOVBSK LHA PA.6": GOSUB 11000: GOTO 6690
6640 IF LCL = 17 AND ARG = 2 AND REXIT(17,1) <= 0 THEN D$= "4XLI HSK GLIAW LMW JEZSVMXI XSC ERH MW WSSR EWPIIT7": GOSUB 11000: ILOC(ARG) = -999: REXIT(17,1)=18: GOTO 2500
6650 IF LCL = 29 AND ARG = 12 AND REXIT(29,5) <= 0 THEN D$= "3WKH ERAVSULQJ FRYHUV WKH JDS LQ WKH VWDLUV8": GOSUB 11000: ILOC(ARG) = -999: REXIT(29,5) = 2: REXIT(2,6) = 29: GOTO 2500
6690 ILOC(ARG) = LCL: PRINT VOCAB$(INPTK(2)); ": DROPPED": GOTO 5000
6700 ARG = INPTK(2) - ITEMOFF
6740 IF ILOC(ARG) <> 0 AND ILOC(ARG) <> LCL THEN D$= "9RC'B WXC QNAN3": GOSUB 11000: GOTO 5000
...
6820 IF LCL = 5 THEN D$= "2VJG MGA FQGUP'V HKV VJG NQEM8": GOSUB 11000: GOTO 5000
6830 IF LCL = 17 THEN D$ = "3BRX XQORFN WKH GRRU. EHZDUH!4": GOSUB 11000: REXIT(17,4) = 20: GOTO 2500
...
7020 IF LCL = 12 AND GOARG = 5 THEN D$= "3BRX'UH DIUDLG RI WKH GDUN1": GOSUB 11000: GOTO 5000
7025 IF LCL = 17 AND GOARG = 1 THEN D$= "7FVB ULCLY KPK SPRL AOHA KVN2": GOSUB 11000: GOTO 5000
7030 IF LCL = 23 AND REXIT(23, 6) <= 0 THEN D$ = "8BPM LCUJEIQBMZ UMKPIVQAU QA KWZZWLML IVL EWV'B UWDM2": GOSUB 11000: GOTO 5000 
...
7130 IF COMM <> 23 AND COMM <> 29 AND ILOC(ARG) <> LCL AND ILOC(ARG) <> 0 THEN D$= "5NY'X STY MJWJ3": GOSUB 11000: GOTO 5000
...
7260 D$= "5DTZ OFHP ZU YMJ KWNILJ FSI KNSI F KZXJ ZSIJW NY8": GOSUB 11000: ILOC(3)=LCL: GOTO 2500
7300 IF MVARG <> 13 OR ILOC(2) >= 0 THEN D$ = "2AQW ECP'V FQ VJCV9": GOSUB 11000: GOTO 5000
7310 D$="5DTZ RTAJ YMJ HTZHM FSI KNSI F YJIIDGJFW GJMNSI NY7": GOSUB 11000: ILOC(2)=LCL: GOTO 2500
7350 IF MVARG <> 11 THEN D$ = "4CSY GER'X HS XLEX9": GOSUB 11000: GOTO 5000
7360 D$="3PRYLQJ WKH FORWKHV UHYHDOV D ODXQGUB FKXWH WR WKH EDVHPHQW3": GOSUB 11000: REXIT(LCL,6) = 27: GOTO 2500
7400 IF LCL <> 20 THEN D$ = "3KXK?9": GOSUB 11000: GOTO 5000
...
7470 GOSUB 8025
7480 IF DOORDIR = SAFED THEN D$= "1PQFOJOH UIF EPPS SFWFBMT B EVNCXBJUFS2": GOSUB 11000: REXIT(LCL, 4) = 23: GOTO 2500
...
7500 IF LCL <> 12 THEN D$ = "6EUA IGT'Z JU ZNGZ9": GOSUB 11000: GOTO 5000
...
7610 IF LCL = 18 THEN D$= "1UIFSF JT B GMBTI PG MJHIU BOE B DSBDLJOH TPVOE.  BO PQFOJOH BQQFBST JO UIF FBTU XBMM1": GOSUB 11000: REXIT(18, 3) = 19: GOTO 2500
7620 INVERSE: D$= "7DOLL!7": GOSUB 11000: NORMAL: PRINT "": GOTO 5000
7700 IF LCL <> 20 THEN D$ = "3BRX FDQ'W GR WKDW9": GOSUB 11000: GOTO 5000
...
7800 IF LCL <> 30 OR (INPTK(2) - ITEMOFF <> 3) THEN D$ = "8GWC KIV'B LW BPIB9": GOSUB 10000: GOTO 5000
...
8200 IF LCL = 20 AND (INPTK(2) - ITEMOFF) = IMOFF + 4 THEN D$= "5UQJFXJ XUJHNKD QJKY, HJSYJW, TW WNLMY4": GOSUB 11000: GOTO 5000
...
10005 CS = 0: OFS = ASC(MID$(D$,1,1))-48
10010 FOR DC = 2 to LEN(D$)-1
10020 D2AS = ASC(MID$(D$,DC,1)): IF D2AS >= 65 AND D2AS <= 90 THEN D2AS = D2AS - OFS: IF D2AS < 65 THEN D2AS = D2AS+26

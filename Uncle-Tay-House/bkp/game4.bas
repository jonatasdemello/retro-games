...
DEF FN_7400():
    IF LCL <> 20 THEN
		...
		PRINT D2$
		GOTO 5000
    IF INPTK(3) - ITEMOFF <> IMMOFF + 4 THEN
		D2$ = "HUH?"
		PRINT D2$
		GOTO 5000
...
DEF FN_7500():
    ...
    IF INPTK(2) - ITEMOFF <> 6 THEN
		...
		PRINT D2$
		GOTO 5000
    IF INPTK(3) - ITEMOFF <> (IMMOFF + 5) THEN
...
DEF FN_7700():
    ...
    IF ILOC(15) <> 0 THEN
		...
		PRINT D2$
		GOTO 5000
    IF INPTK(2) - ITEMOFF <> IMMOFF + 6 THEN
		D2$ = "HUH?"
		PRINT D2$
		GOTO 5000
...
DEF FN_7800():
    IF LCL <> 30 OR (INPTK(2) - ITEMOFF <> 3) THEN 
		...
		PRINT D2$
		GOTO 5000
    IF INPTK(3) - ITEMOFF <> (IMMOFF + 7) THEN 
...
DEF FN_8200():
    IF LCL = 20 AND (INPTK(2) - ITEMOFF) = IMMOFF + 4 THEN 

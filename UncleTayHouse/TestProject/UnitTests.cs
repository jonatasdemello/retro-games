...
namespace TestProject
{
    ...
    public class UnitTests
    {
        ...
        public void Input_Bad_Word(string prompt)
        {
            ...
            Assert.IsFalse(Array.Exists(game.InputWordText_INWS, item => item != ""));
        ...
        public void Input_Direction_Ok(string prompt)
        {
            ...
            Assert.AreEqual(game.InputWordText_INWS[1], "NORTH");
        ...
        public void Input_Multi_Word(string prompt)
        {
            ...
            Assert.AreEqual(game.InputWordText_INWS[1], "TAKE");
            Assert.AreEqual(game.InputWordText_INWS[2], "NEWSPAPER");
        ...
        public void Input_Multi_Word2(string prompt)
        {
            ...
            Assert.AreEqual(game.InputWordText_INWS[1], "MOVE");
            Assert.AreEqual(game.InputWordText_INWS[2], "FRIDGE");
            Assert.AreEqual(game.InputWordText_INWS[3], "JACK");
